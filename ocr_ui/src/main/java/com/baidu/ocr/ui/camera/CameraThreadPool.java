...
public class CameraThreadPool {
     ...
     * 线程池大小
     */
    private static final int poolCount = Runtime.getRuntime().availableProcessors();

    private static final ExecutorService fixedThreadPool = Executors.newFixedThreadPool(poolCount);
