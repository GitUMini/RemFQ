...
public class CameraActivity extends Activity {
    ...
    private void initNative(final String token) {
        CameraNativeHelper.init(CameraActivity.this, token, (errorCode, e) -> cameraView.setInitNativeStatus(errorCode));
    }
    ...
    private final CameraView.OnTakePictureCallback autoTakePictureCallback = new CameraView.OnTakePictureCallback() {
        @Override
    ...
    private final View.OnClickListener confirmButtonOnClickListener = v -> doConfirmResult();

    private final View.OnClickListener confirmCancelButtonOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private final View.OnClickListener rotateButtonOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            cropView.rotate(90);
        }
